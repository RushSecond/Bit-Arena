...
bool TextureShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../GameEngine/Texture.vs", L"../GameEngine/texture.ps");
	if(!result)
	{
		return false;
	}
...
bool TextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	// EDIT: use D3D11_FILTER_MIN_MAG_MIP_POINT to ensure that magenta colors
	// are properly picked up by the shader and turned transparent
